...
use App\Http\Controllers\Api\ProviderActivityController;
...
use App\Http\Controllers\Api\ProviderMonitoringController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/provider/activity', [ProviderActivityController::class, 'index']);
    Route::get('/provider/monitoring', [ProviderMonitoringController::class, 'index']);
